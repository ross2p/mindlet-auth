...
import type { TwoFactorEnrollmentEntity } from '../two-factor-enrollment.entity';

export const twoFactorEnrollmentEntitySchema =
  Joi.object<TwoFactorEnrollmentEntity>({
